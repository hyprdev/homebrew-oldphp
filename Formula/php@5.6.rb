class PhpAT56 < Formula
  desc "General-purpose scripting language / No HTTPD module"
  ...
  def install
    ...
    args = %W[
      ...
      --with-curl=#{Formula["curl-openssl-one"].opt_prefix}
      --with-fpm-user=_www
      --with-fpm-group=_www
...
@@ -71,4 +71,12 @@ ZEND_API int zend_eval_stringl_ex(char *str, int str_len, zval *retval_ptr, char
